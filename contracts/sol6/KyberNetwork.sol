...
contract KyberNetwork is WithdrawableNoModifiers, Utils5, IKyberNetwork, ReentrancyGuard {
    ...
    /// @dev No. of KyberNetworkProxies is capped
    ...
    function removeKyberProxy(address networkProxy) external virtual {
        ...
        kyberStorage.removeKyberProxy(networkProxy);
        ...
        returns (uint256 destAmount, uint256 rateWithNetworkFee)
    {
        ...
        //*MATH circualting eth 1e26 = 110 Million ETH. but we need this limit assumption for later calc.
        ...
        // calculate fees
        //*MATH networkFeeBps * 2 + platfromFeeBps < BPS
    ...
    function createRebateEntitledList(
        ...
        for (uint256 i = 0; i < reservesData.isEntitledRebateFlags.length; i++) {
            if (reservesData.isEntitledRebateFlags[i]) {
                ...
                //*MATH entitledRebateBps > splitsBps[i]. see validateTradeCalcDestQtyAndFeeData
